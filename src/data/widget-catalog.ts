...
export const widgetCatalog: readonly WidgetEntry[] = [
  ...
  // ── Text & Styling ────────────────────────────────────────────────────
  { name: "Text", category: "Text & Styling", description: "Displays a string of text with single style.", commonProps: ["data", "style", "textAlign", "maxLines", "overflow", "softWrap", "textScaleFactor"], tips: "Use Theme.of(context).textTheme for consistent styling. overflow: TextOverflow.ellipsis for truncation." },
